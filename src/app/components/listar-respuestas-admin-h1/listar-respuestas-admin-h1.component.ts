...
@Component({
  selector: 'app-listar-respuestas-admin-h1',
  templateUrl: './listar-respuestas-admin-h1.component.html',
  styleUrls: ['./listar-respuestas-admin-h1.component.css']
})
export class ListarRespuestasAdminH1Component implements OnInit {
