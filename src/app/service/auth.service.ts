...
export class AuthService {
  ...
  async login(email:string,pass:string){
    this.auth.signInWithEmailAndPassword(email,pass).then(value =>{
        ...
        if (email == "jose_morenoperalta@cargill.com") {
        ...
        }else if (email == "diego_munoz@cargill.com") {
          this.router.navigate(['/listar-respuestas-admin']);
          ...
          this.router.navigate(['/listar-respuestas-admin']);          
        }else if (email == "alfredo.1203@hotmail.com"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else if (email == "julio.martinez@proforest.net"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else if (email == "maximino.rivas@proforest.net"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else if (email == "sergio@proforest.net"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else if (email == "esteban@proforest.net"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else if (email == "mar.diaz@proforest.net"){
          this.router.navigate(['/agricultura-regenerativa']);          
        }else{
